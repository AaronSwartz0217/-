...
const DISCLAIMER_HTML = `
  <p>本站为公益性就业风险提示项目，旨在保护求职者知情权，为公共利益提供求职参考，不属于商业运营性质的评价与评级机构。</p>
  <p>本项目为海外在读留学生独立开发的前端课程实训作品，托管于 GitHub 开源代码仓库，仅用于网页开发、地理数据可视化技术学习与交流，全程无广告、无付费项目、无任何商业盈利行为，与文中所有企业均不存在竞争、合作等利益关联，不存在商业诋毁与不正当竞争意图。</p>
  <p>站内所有文字、企业相关资讯完全由第三方人工智能自主汇总生成，运营方仅搭建纯前端页面用于静态展示，不参与事实编撰、主观修改、定向撰写负面内容。内容素材源自网络公开求职讨论、裁判公示信息、网友经验分享，仅作善意风险提示，不构成对任何企业的官方定性、事实结论或法律意见。作为市场经营主体，相关企业对劳动者的用工体验评价负有合理容忍义务。</p>
  <p>运营方仅提供静态信息展示与技术实现，已对明显不实、带有侮辱性的内容进行基础过滤，但无法对 AI 输出信息逐一开展线下事实核验，不对内容的真实性、完整性、准确性、时效性作出任何保证。</p>
  <p>本项目为纯前端静态页面，无后台、无用户系统、无持久化数据服务，不主动推送、引流、传播站内内容，访问均为访客主动触发，传播范围有限。所有信息仅对应特定时间段、特定岗位的反馈，不代表相关企业的当前经营全貌与全部岗位情况。</p>
  <p>本站未使用任何企业的商标、标识、商号进行商业使用，内容仅为文字信息的客观整理呈现，并非针对单一主体的针对性评价。</p>
  <p>访客应当自主审慎甄别站内全部信息，求职、入职相关抉择请以企业官方信息为准，因参考本站信息产生的一切后果，均由访客自行承担。</p>
  <p>若相关企业主体认为本站内容侵犯自身合法权益，可通过公示投诉渠道提交完整资质文件、相关佐证材料及官方说明，我方将在 24 小时内核实，并根据情况采取内容更正、补充企业回应、直至删除整个代码仓库下线全部内容等处置措施，充分保障企业的申辩与救济权利。</p>
  <p>未经运营方书面许可，禁止爬虫批量抓取、二次汇编以及大规模转发本项目全部或部分内容。</p>
